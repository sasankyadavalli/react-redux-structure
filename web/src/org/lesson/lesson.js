      ...
      <div className="course-page">
        ...
        <div className="course-page-body">
         <section className="course-body pl-6 pr-6" >
          <h6 className="mb-4">{this.state.formStatus == 'edit' ? 'Edit Draft Class' : 'Create New Lesson'}</h6>
              ...
              <Input type="text" name="lesson_name" value={this.state.lesson_name} onChange={(e) => this.handleChange(e, ['required'])} placeholder="Impact or Intrinsic" />
            ...
            <FormGroup color={errors.lesson_content ? "danger" : ""}>
              ...
              <Input type="text" name="lesson_content" value={this.state.lesson_content} onChange={(e) => this.handleChange(e, ['required'])} placeholder="Write something" />
              {errors.lesson_content ? <FormFeedback>{errors.lesson_content}</FormFeedback> : "" }
            </FormGroup>
            <FormGroup>
            <Label>Preview Image</Label>
              <div className="mb-2">
                <Button outline color="primary" size="sm" onClick={this.toggle}>Select stock image</Button>{' '}
                <span>
