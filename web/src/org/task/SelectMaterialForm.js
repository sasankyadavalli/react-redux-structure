...
class SelectMaterial extends Component {
  ...
  onRadioBtnChange(e) {
    ...
    const materialsFilter=_.filter(this.props.materials, _.matches({ 'type':value }));
    this.setState({'materials':materialsFilter});
  }
  selectOneMaterial(event){
    event.preventDefault();
    this.props.material_selected(this.state.material_id);
  }
  ...
  render() {
    ...
    <div>
      ...
      <ModalFooter>
        ...
        <Button size="lg" color="cancel">Cancel</Button>
      </ModalFooter>
    </div>
  );
  }
