...
class EditMaterial extends Component{
  constructor(props){
    ...
    this.state = {
      modal: false,
      'value':props.material_type,
      'content':props.materialdata.length ? '': props.materialdata.content,
      'title':props.materialdata.length ? '': props.materialdata.title,
      'url':props.materialdata.length ? '':props.materialdata.url,
      'author':props.materialdata.length ? '':props.materialdata.author,
      'hero_image':props.materialdata.length ? '':props.materialdata.hero_image,
      'estimated_time':props.materialdata.length ? '':props.materialdata.estimated_time,
      'questions':props.materialdata.length ? props.materialdata : '',
      'question' : props.materialdata.length ? '' : props.materialdata.question
  ...
  componentWillMount(){
    if(this.props.materialdata.length){
    this.setState({
      'value':this.props.material_type,
 ...
 cancel(e){
  ...
  updateMaterial(e){
    ...
    this.props.updateMaterialdata(object);
  }
  contentChange(val){
        ...
        <FormGroup check>
             ...
             <FormGroup className={(this.state.value == 'Editor')|| (this.state.value == 'Reflection') || (this.state.value == 'Quiz') ? 'hide' : 'show'}>
                ...
                <FormGroup className={(this.state.value == 'Reflection') || (this.state.value == 'Quiz') ? 'hide' : 'show'}>
                  ...
                  <Button size="sm" color="primary" outline onClick={this.toggle}>Select Stock Image</Button>{' '}
                  ...
                  <Modal isOpen={this.state.modal} toggle={this.toggle}>
                   <ModalHeader toggle={this.toggle}>Select Image</ModalHeader>
                    ...
                    <Button size="lg" color="cancel" onClick={this.cancel}>Cancel</Button>
                    </ModalFooter>
                  </Modal>
                </FormGroup>
                ...
                <FormGroup style={{float:'right'}}>
                 <Button size="lg" color="primary" onClick={this.updateMaterial}>Update</Button>
                  ...
                  {'   '}<Button size="lg" color="cancel" onClick={this.resetClick}>Cancel</Button>
                </FormGroup>
