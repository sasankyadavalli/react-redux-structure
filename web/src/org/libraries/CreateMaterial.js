...
class CreateMaterial extends Component{
  ...
  onRadioBtnChange(e) {
    ...
    this.props.materialaction(this.state.materialshow);
   }
...
toggle(e) {
 ...
 selected_image(id){
          ...
          return response.json().then(data => {
            ...
            if(data.status =='success' && data.result){
              this.setState({
                ...
                estimated_time :this.formatTime(data.result.estimated_time),
                'errors':{}
                });
              this.checkTheFields(this.state.value);
  ...
  newquestion(questions){
    ...
    this.props.questionslist(this.state.questions);
              ...
              <FormGroup className="border-wrapper">
                ...
                <div className={this.state.materialshow ? 'show' : 'hide'}>
                  ...
                  <FormGroup color={errors.author ? "danger" : ""} className={(this.state.value == 'Article')||(this.state.value == 'Podcast') ? 'show' : 'hide'}>
                   ...
                   <FormGroup class={errors.content ? "danger" : ""} className={(this.state.value == 'Editor')? 'show' : 'hide'}>
                    <Label>Content</Label>
                  ...
                  <FormGroup color={errors.estimated_time ? "danger" : ""} className={(this.state.value == 'Video')||(this.state.value == 'Link')|| (this.state.value == 'Reflection') || (this.state.value == 'Quiz')? 'hide' : 'show'}>
                  ...
                  <FormGroup color={errors.question ? "danger" : ""} className={this.state.value == 'Reflection' ? 'show' : 'hide'}>
                    ...
                    <Input type="text" placeholder="Here will be question"  name="question" value={this.state.question} onChange={(e) => this.onChange(e, ['required'])}/>
                ...
                <FormGroup  className={(this.state.value == 'Reflection') || (this.state.value == 'Quiz') ? 'hide' : 'show'}>
                  ...
                  <Button className="btn-outline-primary btn-sm"  onClick={this.toggle}>Select Stock Image</Button>{' '}
