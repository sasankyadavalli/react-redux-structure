        ...
        <ReactTable className="-highlight" data={this.props.surveys} columns={columns} defaultPageSize={9} showPagination={this.props.surveys.length > 9 ? true : false}/> 
          ...
          {this.state.isModalDeleteOpen ?
              <Modal isOpen={this.state.isModalDeleteOpen} toggle={this.toggleDelete}>
                  ...
                  <ModalBody>
                    <div><p className="text-center m-5"> Are you sure want to Delete survey{' '}{this.state.surveyName} ?</p></div>
                  </ModalBody>
                  <ModalFooter>
                    <Button size="lg" color = "primary" id={this.state.surveyId} name={this.state.currentSurveyStat} onClick={this.deleteSurvey}> Delete </Button>{' '}
                    <Button size="lg" color = "cancel" onClick={this.toggleDelete}> Cancel </Button>
                  </ModalFooter>
