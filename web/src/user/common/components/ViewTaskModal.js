  ...
  render(){
    return(
      <div>
        ...
        <ViewMaterial completeTaskAction={this.props.completeTaskAction} matrialFrom={this.props.matrialFrom} materialFlag={this.materialflag} materialObj={this.props.materialObj}/>
