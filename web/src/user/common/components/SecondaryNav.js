          ...
          <Collapse isOpen={this.state.isOpen} navbar>
            <Nav className="ml-auto" navbar>
                ...
                <Dropdown isOpen={this.state.dropdownOpen} toggle={this.toggleDropDown}>
                  <DropdownToggle caret className="mr-3">
                    <div className="user-avatar-name">
                      {userdata.name} <br/>
                      <small className="text-muted">43,000,000 XP</small>
                    </div>
              ...
              <NavItem onClick={this.toggleNotification} className="d-flex align-items-center notification-icon">
                <img src="/assets/notification-bar.svg"/>
              </NavItem>
            </Nav>
          </Collapse>
        </Navbar>

        {this.state.isNotificationOpen ? <NotificationsPanel notificationlist={this.props.notificationlist} close={this.toggleNotification}/> : ''}
